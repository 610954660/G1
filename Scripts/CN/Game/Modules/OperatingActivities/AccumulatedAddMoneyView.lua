--Name : AccumulatedAddMoneyView.lua
--Author : generated by FairyGUI
--Date : 2020-7-8
--Desc : --累计充值豪礼  7日累充

local AccumulatedAddMoneyView, Super = class("AccumulatedAddMoneyView", Window)
local ItemConfiger = require "Game.ConfigReaders.ItemConfiger"
function AccumulatedAddMoneyView:ctor()
    LuaLog("AccumulatedAddMoneyView ctor")
    ...
    --self._compName = "AccumulatedAddMoneyView2"
    --self._rootDepth = LayerDepth.Window
    self.viewIndexTag = GameDef.ActivityType.AccCharge
    self.starInfo = false
    self.bannerUrl = false
end

function AccumulatedAddMoneyView:_initEvent()
end

function AccumulatedAddMoneyView:_initVM()
    local vmRoot = self
    local viewNode = self.view
    ---Do not modify following code--------
    --{vmFields}:OperatingActivities.AccumulatedAddMoneyView
    ...
    --{vmFieldsEnd}:OperatingActivities.AccumulatedAddMoneyView
    --Do not modify above code-------------
end

function AccumulatedAddMoneyView:setActType(_args)
 --   printTable(21, "累计充值打印的数据111111", _args)
end

function AccumulatedAddMoneyView:_initUI()
    self:_initVM()
  --  printTable(21, "累计充值打印的数据", self._args)
    self:showView()
end

function AccumulatedAddMoneyView:showCountTime()
...
function AccumulatedAddMoneyView:showView()
...
function AccumulatedAddMoneyView:activity_AccumulatedAddInfoupdate(...)
	self.starInfo, self.bannerUrl = OperatingActivitiesModel:getAccumulatedAddInfo(self.viewIndexTag, true)
	self.list_item:setNumItems(#self.starInfo);
end
	

return AccumulatedAddMoneyView
