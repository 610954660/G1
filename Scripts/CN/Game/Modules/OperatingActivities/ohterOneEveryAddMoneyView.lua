--Name : ohterOneEveryAddMoneyView.lua
--Author : generated by FairyGUI
--Date : 2020-7-8
--Desc : --每日累充

local ohterOneEveryAddMoneyView, Super = class("ohterOneEveryAddMoneyView", Window)
local ItemConfiger = require "Game.ConfigReaders.ItemConfiger"
function ohterOneEveryAddMoneyView:ctor()
    LuaLog("ohterOneEveryAddMoneyView ctor")
    self._packName = "OperatingActivities"
    self._compName = "ohterOneEveryAddMoneyView"
    --self._rootDepth = LayerDepth.Window
    self.lihuiDisplay = false
    self.lihuiDisplayObj = false
    self.viewIndexTag = GameDef.ActivityType.AccChargeDayCopy
    self.starInfo = false
    self.bannerUrl = false
end

function ohterOneEveryAddMoneyView:_initEvent()
end

function ohterOneEveryAddMoneyView:_initVM()
    local vmRoot = self
    local viewNode = self.view
    ---Do not modify following code--------
    --{vmFields}:OperatingActivities.ohterOneEveryAddMoneyView
    ...
    --{vmFieldsEnd}:OperatingActivities.ohterOneEveryAddMoneyView
    --Do not modify above code-------------
end

function ohterOneEveryAddMoneyView:setActType(_args)
 --   printTable(21, "累计充值打印的数据111111", _args)
end

function ohterOneEveryAddMoneyView:_initUI()
    self:_initVM()
...
function ohterOneEveryAddMoneyView:showCountTime()
    ...
    self.txt_dec:setText(actData.showContent.title)
...
function ohterOneEveryAddMoneyView:showView()
    ...
    self.list_item:setItemRenderer(
        function(index, obj)
			...
			obj:getChild("$txt_desc"):setText(Desc.activity_txt29..ColorUtil.formatColorString1(itemInfo.accType,"#0ea41d")..Desc.activity_txt7)
            ...
            btn:addClickListener(
                function()
                    OperatingActivitiesModel:AccChargeDayRecieveReward(self.viewIndexTag,itemInfo.id)
                end,
                100
            )
            -- 前往按钮
...
function ohterOneEveryAddMoneyView:activity_AccumulatedAddInfoupdate(...)
	self.starInfo, self.bannerUrl = OperatingActivitiesModel:getAccumulatedAddInfo(self.viewIndexTag, true)
	self.list_item:setNumItems(#self.starInfo);
end
	

return ohterOneEveryAddMoneyView
