...
local TwistEggShopView = class("TwistEggShopView",Window)

function TwistEggShopView:ctor()
...
function TwistEggShopView:_initUI()
...
function TwistEggShopView:_initEvent()
    self:TwistEggShop_refreshPanal()
end

function TwistEggShopView:TwistEggShop_refreshPanal()
    self:refreshPanal()
end

function TwistEggShopView:refreshPanal()
...
-- 设置积分
function TwistEggShopView:setIntegral()
    local shopData = TwistEggShopModel:getShopData()
...
-- 设置商品列表
function TwistEggShopView:setShopList()
    local shopData = TwistEggShopModel:getShopData()
    self.list_goods:setItemRenderer(function(idx,obj)
        ...
        obj:addClickListener(function()
            ...
            -- local reqInfo = {
            --     activityId = GameDef.ActivityType.GashaponShop,
            --     id = data.id,
            -- }  
            -- RPCReq.Activity_GashaponShop_Buy(reqInfo,function(params)
            -- end)

            ViewManager.open("TwistEggShopTipsView", {showData = data,buyTime=data.buyTime})
        end,11)
...
-- 倒计时
function TwistEggShopView:updateCountTimer()
...
function TwistEggShopView:_exit()
