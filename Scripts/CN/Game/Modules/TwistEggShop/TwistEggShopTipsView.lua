local TwistEggShopTipsView = class("TwistEggShopTipsView",Window)
function TwistEggShopTipsView:ctor()
...
function TwistEggShopTipsView:_initUI()
...
function TwistEggShopTipsView:_initEvent()
	self:TwistEggShopTipsView_upDate()
end


function TwistEggShopTipsView:TwistEggShopTipsView_upDate()
	...
	self.btn_ok:addClickListener(function()
		if haveMoney >= (costRes.amount * buyNum) then
			...
			ViewManager.close("TwistEggShopTipsView")
        else
