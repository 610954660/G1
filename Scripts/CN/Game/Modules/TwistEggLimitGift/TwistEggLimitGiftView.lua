...
local TwistEggLimitGiftView = class("TwistEggLimitGiftView",Window)

function TwistEggLimitGiftView:ctor()
...
function TwistEggLimitGiftView:_initUI()
...
function TwistEggLimitGiftView:_initEvent()
    self:TwistEggLimitGift_refreshPanal()
end

function TwistEggLimitGiftView:TwistEggLimitGift_refreshPanal()
    self:refreshPanal()
end

function TwistEggLimitGiftView:refreshPanal()
    self:setGiftList()
    self:updateCountTimer()
end

-- 设置礼包列表
function TwistEggLimitGiftView:setGiftList()
    local giftData = TwistEggLimitGiftModel:getShopData()
    self.list_gift:setItemRenderer(function(idx,obj)
        ...
        if data.price == 0 then
            ...
            RedManager.register("V_ACTIVITY_"..GameDef.ActivityType.GashaponGift .. data.id, img_red)
        ...
        btn_buy:addClickListener(function()
            ...
            -- end)
            ModelManager.RechargeModel:directBuy(data.price,  GameDef.StatFuncType.SFT_GashaponGift, data.id,data.name, nil,data.showName1)
        end,11)
...
-- 倒计时
function TwistEggLimitGiftView:updateCountTimer()
...
function TwistEggLimitGiftView:_exit()
