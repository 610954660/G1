local ExtraordinaryAnimationView,Super = class("ExtraordinaryAnimationView", Window)

function ExtraordinaryAnimationView:ctor()
...
function ExtraordinaryAnimationView:_initEvent()
	
end

function ExtraordinaryAnimationView:_initVM()
	local viewNode = self.view
	---Do not modify following code--------
	--{autoFields}:CrossPVP.ExtraordinaryAnimationView
	...
	--{autoFieldsEnd}:CrossPVP.ExtraordinaryAnimationView
	--Do not modify above code-------------
end

function ExtraordinaryAnimationView:_initUI()
	self:_initVM()
	self.blackbg:addClickListener(function()
		self:closeView()
		ExtraordinarylevelPvPModel:openBattlePreView(self._args)
	end)
...
function ExtraordinaryAnimationView:_refreshView()

end

function ExtraordinaryAnimationView:onExit_()

end

return ExtraordinaryAnimationView