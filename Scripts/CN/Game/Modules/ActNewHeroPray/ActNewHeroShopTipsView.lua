...
--Author : 新英雄皮肤售卖
--Desc : 新英雄皮肤售卖
local ActNewHeroShopTipsView = class("ActNewHeroShopTipsView",Window)
function ActNewHeroShopTipsView:ctor()
...
function ActNewHeroShopTipsView:_initUI()
...
function ActNewHeroShopTipsView:_initEvent()
	self:ActNewHeroShopTipsView_upDate()
end


function ActNewHeroShopTipsView:ActNewHeroShopTipsView_upDate()
	...
	self.btn_ok:addClickListener(function()
		if haveMoney >= (costRes.amount * buyNum) then
			local reqInfo = {
                activityId = GameDef.ActivityType.NewHeroSummonExchange,
				id = showData.id,
				buyCount = buyNum,
            }  
