--added by xiehande
--功能 UP探员招募探员选定
local UPHeroSelectView,Super = class("UPHeroSelectView", Window)
function UPHeroSelectView:ctor(args)
	LuaLogE("UPHeroSelectView ctor")
	self._packName = "GetCardsUpActivity"
	self._compName = "UPHeroSelectView"
...
function UPHeroSelectView:showEffect( ... )
...
--更新页面
function UPHeroSelectView:updatePanel()
	...
	GetCardsUPActivityModel:setLastHeroCode( self._args.heroCode )
	Dispatcher.dispatchEvent("update_yj_heroPage")
end

function UPHeroSelectView:showSpine(  )
    if self.timer then
...
function UPHeroSelectView:_initUI()
...
function UPHeroSelectView:_initEvent( ... )
end

function UPHeroSelectView:_exit( ... )
