--Name : ActivityFrame8View.lua
--Author : generated by FairyGUI
--Date : 2020-5-9
--Desc : added by xhd UI框架模态2

local ActivityFrameViewBase = require "Game.Modules.ActivityFrame.ActivityFrameViewBase"
local ActivityFrame8View,Super = class("ActivityFrame8View", ActivityFrameViewBase)
local ActivityMap = require "Game.Modules.Activity.ActivityMap"
function ActivityFrame8View:ctor()
	self._packName = "ActivityFrame"
	self._compName = "ActivityFrame8View"
end

function ActivityFrame8View:_initEvent( )
end

function ActivityFrame8View:close_ActivityView( mainActiveId,actType )
	local inFlag = false
	local mid = 0 
