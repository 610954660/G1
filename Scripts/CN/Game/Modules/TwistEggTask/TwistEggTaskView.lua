...
local TwistEggTaskView = class("TwistEggTaskView",Window)

function TwistEggTaskView:ctor()
...
function TwistEggTaskView:_initUI()
...
function TwistEggTaskView:_initEvent()
    self:TwistEggTask_refreshPanal()
end

function TwistEggTaskView:TwistEggTask_refreshPanal()
    self:refreshPanal()
end

function TwistEggTaskView:refreshPanal()
...
-- 设置总的任务进度
function TwistEggTaskView:setTotalTaskItem()
    local totalTaskData     = TwistEggTaskModel:getAllTaskData()   -- 总任务进度
    ...
    local moduleId = TwistEggModel:getModuleId()
    ...
    RedManager.register("V_ACTIVITY_"..GameDef.ActivityType.GashaponTask .. totalTaskData.id, img_red)
    totalBtn_take:removeClickListener(11)
    totalBtn_take:addClickListener(function()
        local reqInfo = {
            activityType = GameDef.ActivityType.GashaponTask,
            id = totalTaskData.id,
        }
...
-- 设置任务列表
function TwistEggTaskView:setTaskList()
    local taskData = TwistEggTaskModel:getTaskData()
    self.list_task:setItemRenderer(function(idx,obj)
        ...
        RedManager.register("V_ACTIVITY_"..GameDef.ActivityType.GashaponTask .. data.id, img_red)
...
-- 倒计时
function TwistEggTaskView:updateCountTimer()
...
function TwistEggTaskView:_exit()
