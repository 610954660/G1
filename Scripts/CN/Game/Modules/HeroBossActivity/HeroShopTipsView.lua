local HeroShopTipsView = class("HeroShopTipsView",Window)
function HeroShopTipsView:ctor()
    self._packName  = "HeroBossActivity"
    self._compName  = "HeroShopTipsView"
...
function HeroShopTipsView:_initUI()
...
function HeroShopTipsView:_initEvent()
	self:HeroShopTipsView_upDate()
end


function HeroShopTipsView:HeroShopTipsView_upDate()
	...
	self.btn_ok:addClickListener(function()
		if haveMoney >= (costRes.amount * buyNum) then
			local reqInfo = {
                activityId = GameDef.ActivityType.NewHeroShop,
				id = showData.id,
				buyCount = buyNum,
            }  
            RPCReq.Activity_NewHeroShop_Buy(reqInfo,function(params)
            end)
			ViewManager.close("HeroShopTipsView")
        else
...
function HeroShopTipsView:_exit()
end
return HeroShopTipsView
