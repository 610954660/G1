local DetectiveTrialShopTipsView = class("DetectiveTrialShopTipsView",Window)
function DetectiveTrialShopTipsView:ctor()
    self._packName  = "TwistEggShop"
    self._compName  = "TwistEggShopTipsView"
...
function DetectiveTrialShopTipsView:_initUI()
...
function DetectiveTrialShopTipsView:_initEvent()
	self:DetectiveTrialShopTipsView_upDate()
end


function DetectiveTrialShopTipsView:DetectiveTrialShopTipsView_upDate()
	...
	self.btn_ok:addClickListener(function()
		if haveMoney >= (costRes.amount * buyNum) then
			...
			if self._args.type == GameDef.ActivityType.CollectThingsShop then
				reqInfo = {
					activityId = GameDef.ActivityType.CollectThingsShop,
					id = showData.id,
					buyCount = buyNum,
				}  
			...
			ViewManager.close("DetectiveTrialShopTipsView")
        else
            RollTips.show(Desc.TwistEggShop_noInter)
            return
...
return DetectiveTrialShopTipsView
