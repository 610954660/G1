...
cc.TEXTURE2_D_PIXEL_FORMAT_ATC_EXPLICIT_ALPHA     = 0x13
cc.TEXTURE2_D_PIXEL_FORMAT_ATC_INTERPOLATED_ALPHA     = 0x14
cc.TEXTURE2_D_PIXEL_FORMAT_DEPTH_COMPONENT     = 0x15
